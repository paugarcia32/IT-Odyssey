          ...
          <div className="md:flex md:mt-10">
            ...
            <div className="md:w-3/4 md:pl-8">
              ...
              <p className="mb-4">
                ...
                conditions. Do not continue to use My Dev Journey if you do not agree
              ...
              <p className="mb-4">
                ...
                services, in accordance with and subject to, prevailing law of es. Any
              ...
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Cookies</h2>
              <p className="mb-4">
                We employ the use of cookies. By accessing My Dev Journey, you agree
                to use cookies in agreement with the My Dev Journey's Privacy Policy.
              </p>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">License</h2>
              <p className="mb-4">
                Unless otherwise stated, My Dev Journey and/or its licensors own the
                intellectual property rights for all material on My Dev Journey. All
                intellectual property rights are reserved. You may access this from My
                Dev Journey for your own personal use subjected to restrictions set
                in these terms and conditions.
              </p>
              <p className="mb-4">
                You must not:
              </p>
              <ul className="my-2.5 pl-5 list-disc mb-4">
                <li>Republish material from My Dev Journey</li>
                <li>Sell, rent or sub-license material from My Dev Journey</li>
                <li>Reproduce, duplicate or copy material from My Dev Journey</li>
                <li>Redistribute content from My Dev Journey</li>
              </ul>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                exchange opinions and information in certain areas of the website. My
                Dev Journey does not filter, edit, publish or review Comments prior to
                their presence on the website. Comments do not reflect the views and
                opinions of My Dev Journey,its agents and/or affiliates. Comments
                reflect the views and opinions of the person who post their views and
                opinions. To the extent permitted by applicable laws, My Dev Journey
                shall not be liable for the Comments or for any liability, damages or
                expenses caused and/or suffered as a result of any use of and/or
                posting of and/or appearance of the Comments on this website.
              </p>
              <p className="mb-4">
                My Dev Journey reserves the right to monitor all Comments and to
              ...
              <p className="mb-4">
                You hereby grant My Dev Journey a non-exclusive license to use,
                reproduce, edit and authorize others to use, reproduce and edit any of
                your Comments in any and all forms, formats or media.
              </p>
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Hyperlinking to our Content</h2>
              <p className="mb-4">
              ...
              <p className="mb-4">
                ...
                the hyperlink compensates the absence of My Dev Journey; and (d) the
              ...
              <p className="mb-4">
                ...
                sending an e-mail to My Dev Journey. Please include your name, your
              ...
              <p className="mb-4">
                No use of My Dev Journey's logo or other artwork will be allowed for
                linking absent a trademark license agreement.
              </p>
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5">iFrames</h2>
              <p className="mb-4">
                Without prior approval and written permission, you may not create
                frames around our Webpages that alter in any way the visual
                presentation or appearance of our Website.
              </p>
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Content Liability</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Reservation of Rights</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Removal of links from our website</h2>
              <p className="mb-4">
              ...
              <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Disclaimer</h2>
              <p className="mb-4">
