  ...
  return(
    <div className="max-w-4xl m-0 mx-auto leading-relaxed p-2 md:p-10 lg:p-20 font-body">
          ...
          <div className="content">
            ...
            <li>
            <p className="mb-4"><strong>Website</strong> refers to My Dev Journey, accessible from <a className="hover:underline text-accent" href="www.itodyssey.dev" rel="external nofollow noopener" target="_blank">www.itodyssey.dev</a></p>
            </li>
            <li>
