  ...
  return(
    <div className="max-w-4xl m-0 mx-auto leading-relaxed p-20 font-body">
          ...
          <div className="content">
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Interpretation and Definitions</h2>
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Interpretation</h3>
            <p className="mb-4">
              The words of which the initial letter is capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
            </p>
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Definitions</h2>
            <p className="mb-4">
            ...
            <li>
            <p className="mb-4">
              <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to My Dev Journey.
            </p>
            </li>
            <li>
            <p className="mb-4">
            ...
            <li>
            <p className="mb-4"><strong>Website</strong> refers to My Dev Journey, accessible from <a className="hover:underline text-accent" href="www.mydevjourney.com" rel="external nofollow noopener" target="_blank">www.mydevjourney.com</a></p>
            </li>
            <li>
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Collecting and Using Your Personal Data</h2>
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Types of Data Collected</h3>
            <h4 className="text-lg font-bold mt-5 mb-1.5 font-title">Personal Data</h4>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Usage Data</h3>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2">Tracking Technologies and Cookies</h3>
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5">Use of Your Personal Data</h2>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Retention of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Transfer of Your Personal Data</h3>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Delete Your Personal Data</h3>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Disclosure of Your Personal Data</h3>
            <h4 className="text-lg font-bold mt-5 mb-1.5 font-title">Business Transactions</h4>
            ...
            <h4 className="text-lg font-bold mt-5 mb-1.5 font-title">Law enforcement</h4>
            ...
            <h4 className="text-lg font-bold mt-5 mb-1.5 font-title">Other legal requirements</h4>
            ...
            <h3 className="text-xl font-bold mt-6 mb-2 font-title">Security of Your Personal Data</h3>
            <p className="mb-4">The security of Your Personal Data is important to Us, but remember that no method of transmission over the Internet, or method of electronic storage is 100% secure. While We strive to use commercially acceptable means to protect Your Personal Data, We cannot guarantee its absolute security.</p>
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Children's Privacy</h2>
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Links to Other Websites</h2>
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Changes to this Privacy Policy</h2>
            ...
            <h2 className="text-2xl font-bold mt-7.5 mb-2.5 font-title">Contact Us</h2>
