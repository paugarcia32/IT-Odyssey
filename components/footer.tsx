...
export default function Footer(){
  return (
    <footer className="bg-secondary font-body ">
      <div
        className=" max-w-7xl m-auto flex flex-col p-16 "
      >
        <div className="lg:flex lg:flex-row grid grid-cols-2 flex-wrap lg:justify-between justify-items-center items-start w-full text-left mb-0.5">
                  {/* <!-- List Container --> */}
